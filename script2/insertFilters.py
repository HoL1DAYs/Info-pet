...
def get_data(url):
    ...
    for filter in filters:
        ...
        connection.execute(
            text(f"insert into infopet.filters(filter_name) values('{filterName}')"))
        connection.commit()
        ...
        for breed in breeds:
            try:
                ...
                connection.execute(text(
                    f"insert into infopet.breed_filters(breed_id, filters_id) values('{breed_id}' ,'{filter_id}' )"))
                print(breed_id, filter_id)
